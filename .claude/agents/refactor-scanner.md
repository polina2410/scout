...
### API Patterns
- Repeated fetch/async patterns in `lib/`
...
export function extractedUtil(...) { ... }

// Refactored call site
const result = extractedUtil(...);
```
**Tradeoff:** Why extraction helps (or any reason to leave it as-is).